...
unsigned char *str_menu[]={ //01.02.2021
		  ...
		  double dyn_prm)
{
  ...
  switch (Display.page)
  {
    ...
    case 10:/*®á­®¢­®¥ ¬¥­î*/
       if (Display.flag==1)
       WriteMenuToMMI(str_menu[Display.num+Display.row],7); else //01.02.2021 was11 now7
       ...
       { 
	 //01.02.2021 case 0: Display.point=7; Display.write=0; GoToMenuMMI(20);break;
	 case 0: GoToMenuMMI(11); break; //was case 0

	 //01.02.2021 case 2: GoToMenuMMI(12); break;

	 case 1: Display.point=1; GoToMenuMMI(13); break; //was case:3
	 case 2: Display.point=0; GoToMenuMMI(13); break; //was case:4

	 //01.02.2021 case 5: Display.point=6; Display.write=0; GoToMenuMMI(20);break;

	 case 3: Display.prm=5; enter_ind=2;GoToMenuMMI(23); break; //was case:6
	 case 4: Display.prm=7; enter_ind=4;GoToMenuMMI(23); break; //was case:7
	 case 5: Display.point=11; Display.row=Horizont=mmi_pass=0; //was case:8
		 Display.flag=1;Display.num=0;SetDisplayPage(14);break;
	 case 6: flg_modem=2; ClearBuffer();Horizont=10;Vertical=3; //was case:9
		 SetDisplayPage(17); break;
	 //01.02.2021 case 10:Display.point=60; Display.write=0;GoToMenuMMI(20);break;
       }
	break;
